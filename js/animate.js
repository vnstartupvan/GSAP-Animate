...
animate.initDesktop = () => {
    animate.run('.icon-different', AnimateOptions.topEntranceList)
...
animate.bounceInDown = ($Selector) => {
    const tl = gsap.timeline({
        scrollTrigger: $Selector,
    });

    tl.fromTo(".btn-booking.btn-commom",
        {
            rotation: 360, duration: 1
        },
        {
            rotation: 0, duration: 2, ease: EaseOptions.bounceOut
        });
}
